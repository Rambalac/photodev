...
namespace com.azi.tiff
{
    ...
    {
        public static IdfType UInt16 = new IdfType {BytesLength = 2};
        public static IdfType UInt32 = new IdfType {BytesLength = 4};
        public static IdfType UInt32Fraction = new IdfType {BytesLength = 8};
    ...
    {
        private static readonly Dictionary<int, IdfTag> TagMap = new Dictionary<int, IdfTag>
        {
        ...
        private static readonly Dictionary<int, IdfType> IdfTypes = new Dictionary<int, IdfType>
        {
            // 11124811248484
            {
                1, new IdfType
